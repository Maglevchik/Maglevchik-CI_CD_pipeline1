...
if os.environ.get('CI') == 'true':
    # Если код запущен в GitHub, используем легкую файловую БД
    DATABASES = {
        'default': {
    ...
    # Иначе используем твой боевой PostgreSQL
    # ВАЖНО: Вставь ниже СВОИ текущие настройки, которые у тебя уже были написаны!
    DATABASES = {
        'default': {
